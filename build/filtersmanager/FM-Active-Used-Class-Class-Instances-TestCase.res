...
<html>
    <body>
        ...
        <label>In this case velocity is not able to create new instances of the filtered classes even through Class.class.</label>
        
        $Class.forName("org.apache.velocity.test.filtersmanager.Car").newInstance()
    </body>
</html>