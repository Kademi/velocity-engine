...
public class ASTMethod extends SimpleNode {
    ...
    public Object execute(Object o, InternalContextAdapter context)
            throws MethodInvocationException {
        /**
         * This snippet of code is going to verify that filters manager was
         * declared first, then passes the class name of the object to filters
    ...
    private Object handleInvocationException(Object o, InternalContextAdapter context, Throwable t) {
         ...
         */ else if (t instanceof Exception) {
             ...
             * If the event handler throws an exception, then wrap it in a
